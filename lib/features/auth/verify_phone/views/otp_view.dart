...
class VerifyDriverPhoneOTPView extends StatefulWidget {
  final Widget screen;
  final String phone;

  const VerifyDriverPhoneOTPView(
      {super.key, required this.screen, required this.phone});

  @override
  State<VerifyDriverPhoneOTPView> createState() =>
      _VerifyDriverPhoneOTPViewState();
}

class _VerifyDriverPhoneOTPViewState extends State<VerifyDriverPhoneOTPView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocProvider(
        create: (context) =>
            DriverVerifyCodeCubit(VerifyDriverPhoneAddressRepo()),
        child: InkWell(
