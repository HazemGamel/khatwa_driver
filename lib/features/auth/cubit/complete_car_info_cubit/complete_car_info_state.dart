...
class PickDriverCriminalImageLoadingState extends CompleteCarInfoState {}
class PickDriverCriminalImageState extends CompleteCarInfoState {}
...
class CriminalLoadingState extends CompleteCarInfoState {}

class CriminalSuccessState extends CompleteCarInfoState {}
class CriminalErrorState extends CompleteCarInfoState {
  final String message;
  CriminalErrorState(this.message);
}
